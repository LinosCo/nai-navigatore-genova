...
-- 3. Add policy to prevent unauthorized insertions to audit log (check if exists first)
DROP POLICY IF EXISTS "Prevent unauthorized audit log insertions" ON public.profile_access_log;
